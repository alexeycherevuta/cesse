...
import { Common } from '../../..'
import { PrismicComponent, HtmlTextComponent, ImageComponent, TextComponent, HyperlinkComponent } from '../../../src/client/helpers/prismicToReact'
import { prismicQueryResponse } from '../../support/prismicFactory'
import { IPrismicComponent, IPrismicHyperlinkComponentBody } from '../../../src/common/intf/IPrismicHelper'
import PrismicComponents from '../../../src/common/props/PrismicComponents'
const debug = (e: any) => {
  console.log(e.debug())
}
